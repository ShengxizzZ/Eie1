...
public class DataUtils {
    ...
    public static final String CategoryClassUrl = DataUtils.baseUrl+"/AppSwevlet/servlet/CategoryServlet";

    public static final String RegisterUrl = DataUtils.baseUrl+"/AppSwevlet/servlet/RegisterServlet";
    public static final String ForumUpUrl = DataUtils.baseUrl+"/AppSwevlet/servlet/ForumUpDataServlet";

    public static final String CATEONE = "c01";
    public static final String CATETWO = "c02";
    public static final String CATETHREE = "c03";
    public static final String CATEFOUR = "c04";
    public static final String CATEFIVE = "c05";
    public static final String CATESIX = "c06";
